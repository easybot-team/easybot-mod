...
import com.springwater.easybot.platforms.fabric.features.LoginEventSyncFeature;
import com.springwater.easybot.platforms.fabric.features.MessageSyncFeature;
import com.springwater.easybot.platforms.fabric.features.PlayerDeathSyncFeature;
import com.springwater.easybot.platforms.fabric.features.PlayerLoginFeature;
...
public class FabricEntry implements ModInitializer {
    ...
    public void onInitialize() throws RuntimeException {
        ...
        LOGGER.info("EasyBot Fabric-" + ModData.VERSION + "+" + ModData.MINECRAFT + " 启动中!");
        try {
            ConfigLoader.load();
    ...
    private static void doDependencyCheck() {
        ...
        if (FabricLoader.getInstance().isModLoaded("placeholder-api")) {
            LOGGER.info("检测到TextPlaceholderAPI 已启动占位符增强功能 [Api:" + ModData.PAPI + "]");
